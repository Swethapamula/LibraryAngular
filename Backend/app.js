...
app.post("/bookinsert",verifyToken, function(req,res){
...
app.delete('/authordelete/:id',verifyToken,function(req,res){
...
app.delete("/bookdelete/:id",verifyToken, function(req,res){
    let id =req.params.id;
...
app.get('/author/:id',verifyToken, function(req,res){
    let id= req.params.id;
...
app.put("/bookupdate",verifyToken, function(req,res)
{
